    ...
    public class SerializableHashSetDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (items.arraySize == 0)
            {
                ...
                var emptyText = string.IsNullOrEmpty(label.text) ? "— Collection is empty —" : $"— {label.text} is empty —";
                EditorGUI.LabelField(emptyRect, emptyText, InspectorStyles.EmptyNotice);
